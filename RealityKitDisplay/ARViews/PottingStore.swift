...
struct PottingStore: View {
    ...
    var body: some View {
        VStack{
            ARPottingViewContainer(selectedPlant: selectedObject,saveWorldMap: saveWorldMap, loadedObjects: $placedModels).edgesIgnoringSafeArea(.all)
...
struct ARPottingViewContainer: UIViewRepresentable {
...
//        }
    ...
    func makeCoordinator() -> PottingCoordinator {
        return PottingCoordinator(selectedPlant)
    }
